...
_mithril2.default.mount(document.body, _mithrilRedux.Provider.init(store, _mithril2.default, _Layout2.default));

},{"./components/Layout":25,"./state/store":30,"mithril":12,"mithril-redux":11}],25:[function(require,module,exports){
'use strict';
...
var Layout = function () {
  ...
  _createClass(Layout, [{
    key: 'view',
    value: function view() {
      return (0, _mithril2.default)('div', [_SidebarContainer.SidebarContainer]);
    }
  }]);
...
},{"./SidebarContainer":26,"mithril":12}],26:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SidebarContainer = undefined;
...
var mapDispatchToProps = {
  closeSidebar: _actions.closeSidebar,
  openSidebar: _actions.openSidebar
};

var SidebarContainer = exports.SidebarContainer = (0, _mithrilRedux.connect)(mapStateToProps, mapDispatchToProps)(_SidebarView2.default);

},{"../state/actions":28,"./SidebarView":27,"mithril-redux":11}],27:[function(require,module,exports){
'use strict';
...
var SidebarView = function () {
  ...
  _createClass(SidebarView, [{
    key: 'view',
    value: function view(dispatcher, _ref) {
      var sidebar = _ref.sidebar;

      return (0, _mithril2.default)('div', [(0, _mithril2.default)('div.sidebar.padding-medium' + (sidebar.isOpen ? '.is-active' : ''), [(0, _mithril2.default)('button.btn-red', { onclick: dispatcher.closeSidebar() }, 'Close')]), (0, _mithril2.default)('button' + (sidebar.isOpen ? '.btn-red' : '.btn-teal'), {
        onclick: sidebar.isOpen ? dispatcher.closeSidebar() : dispatcher.openSidebar()
      }, sidebar.isOpen ? 'Close sidebar' : 'Open sidebar'), (0, _mithril2.default)('p', 'The sidebar is ' + (sidebar.isOpen ? 'open' : 'closed'))]);
    }
  }]);
...
},{"mithril":12}],28:[function(require,module,exports){
'use strict';
...
},{"./actions":28,"redux":19}],30:[function(require,module,exports){
'use strict';
...
function configureStore(initialState) {
  ...
  var createModifiedStore = (0, _redux.applyMiddleware)(_mithrilRedux.redrawMiddleware)(_redux.createStore);

  return createModifiedStore(_reducers2.default, initialState, composeEnhancers());
}

},{"./reducers":29,"mithril-redux":11,"redux":19}]},{},[25,26,27,28,29,30,24]);
